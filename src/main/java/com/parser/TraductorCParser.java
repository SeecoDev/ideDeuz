...
public class TraductorCParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, INT=3, VOID=4, MAIN=5, PRINT=6, FOR=7, IF=8, ELSE=9, TRUE=10, 
		FALSE=11, OR=12, AND=13, IGUALACION=14, DIFERENTE=15, MAYOR=16, MENOR=17, 
		MAYORIGUAL=18, MENORIGUAL=19, IGUAL=20, POW=21, SQRT=22, SUM=23, RES=24, 
		MUL=25, DIV=26, PA=27, PC=28, LA=29, LC=30, COMMENT=31, COMMENTLINEA=32, 
	...
	public static final int
		...
		RULE_ifCuck = 8, RULE_elseCuck = 9, RULE_elseifCuck = 10, RULE_forBasico = 11, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"impresion2", "impresion", "asignacion", "ifCuck", "elseCuck", "elseifCuck", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "';'", "'!'", "'dul'", "'papoi'", "'banana'", "'poopaye'", "'chasy'", 
			"'hana'", "'sae'", "'True'", "'False'", "'||'", "'&&'", "'=='", "'!='", 
			"'>'", "'<'", "'>='", "'<='", "'='", "'**'", "'*/'", "'+'", "'-'", "'*'", 
			"'/'", "'('", "')'", "'{'", "'}'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "INT", "VOID", "MAIN", "PRINT", "FOR", "IF", "ELSE", 
	...
	public static class ProgramaContext extends ParserRuleContext {
		...
		public TerminalNode LA() { return getToken(TraductorCParser.LA, 0); }
		public InstruccionesContext instrucciones() {
			return getRuleContext(InstruccionesContext.class,0);
		}
		public TerminalNode LC() { return getToken(TraductorCParser.LC, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitPrograma(this);
	...
	public static class EncabechadContext extends EncabezadoContext {
		public TerminalNode VOID() { return getToken(TraductorCParser.VOID, 0); }
		public TerminalNode MAIN() { return getToken(TraductorCParser.MAIN, 0); }
		public TerminalNode PA() { return getToken(TraductorCParser.PA, 0); }
		public TerminalNode PC() { return getToken(TraductorCParser.PC, 0); }
		public EncabechadContext(EncabezadoContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitEncabechad(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InstruccionesContext extends ParserRuleContext {
		...
		public List<IfCuckContext> ifCuck() {
			return getRuleContexts(IfCuckContext.class);
		}
		public IfCuckContext ifCuck(int i) {
			return getRuleContext(IfCuckContext.class,i);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitInstrucciones(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final InstruccionesContext instrucciones() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INT) | (1L << PRINT) | (1L << FOR) | (1L << IF) | (1L << ID))) != 0)) {
				{
				setState(49);
				_errHandler.sync(this);
	...
	public static class DeclarachadContext extends DeclaracionContext {
		...
		public TerminalNode ID() { return getToken(TraductorCParser.ID, 0); }
		public DeclarachadContext(DeclaracionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitDeclarachad(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Declarachad2Context extends Declaracion2Context {
		...
		public TerminalNode ID() { return getToken(TraductorCParser.ID, 0); }
		public TerminalNode IGUAL() { return getToken(TraductorCParser.IGUAL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitDeclarachad2(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Imprechad2Context extends Impresion2Context {
		public TerminalNode PRINT() { return getToken(TraductorCParser.PRINT, 0); }
		public TerminalNode PA() { return getToken(TraductorCParser.PA, 0); }
		public TerminalNode STRING() { return getToken(TraductorCParser.STRING, 0); }
		public TerminalNode PC() { return getToken(TraductorCParser.PC, 0); }
		public Imprechad2Context(Impresion2Context ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitImprechad2(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ImprechadContext extends ImpresionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitImprechad(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AsignachadContext extends AsignacionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitAsignachad(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IfCuckContext extends ParserRuleContext {
		public IfCuckContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_ifCuck; }
	 
		public IfCuckContext() { }
		public void copyFrom(IfCuckContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class IfChadContext extends IfCuckContext {
		public TerminalNode IF() { return getToken(TraductorCParser.IF, 0); }
		public TerminalNode PA() { return getToken(TraductorCParser.PA, 0); }
		...
		public TerminalNode LC() { return getToken(TraductorCParser.LC, 0); }
		public List<ElseifCuckContext> elseifCuck() {
			return getRuleContexts(ElseifCuckContext.class);
		}
		public ElseifCuckContext elseifCuck(int i) {
			return getRuleContext(ElseifCuckContext.class,i);
		}
		public ElseCuckContext elseCuck() {
			return getRuleContext(ElseCuckContext.class,0);
		}
		public IfChadContext(IfCuckContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitIfChad(this);
			else return visitor.visitChildren(this);
		}
	}

	public final IfCuckContext ifCuck() throws RecognitionException {
		IfCuckContext _localctx = new IfCuckContext(_ctx, getState());
		enterRule(_localctx, 16, RULE_ifCuck);
		int _la;
		try {
			int _alt;
	...
	public static class ElseCuckContext extends ParserRuleContext {
		public ElseCuckContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_elseCuck; }
	 
		public ElseCuckContext() { }
		public void copyFrom(ElseCuckContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class ElsechadContext extends ElseCuckContext {
		public TerminalNode ELSE() { return getToken(TraductorCParser.ELSE, 0); }
		public TerminalNode LA() { return getToken(TraductorCParser.LA, 0); }
		public InstruccionesContext instrucciones() {
			return getRuleContext(InstruccionesContext.class,0);
		}
		public TerminalNode LC() { return getToken(TraductorCParser.LC, 0); }
		public ElsechadContext(ElseCuckContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitElsechad(this);
			else return visitor.visitChildren(this);
		}
	}

	public final ElseCuckContext elseCuck() throws RecognitionException {
		ElseCuckContext _localctx = new ElseCuckContext(_ctx, getState());
		enterRule(_localctx, 18, RULE_elseCuck);
		try {
	...
	public static class ElseifCuckContext extends ParserRuleContext {
		public ElseifCuckContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_elseifCuck; }
	 
		public ElseifCuckContext() { }
		public void copyFrom(ElseifCuckContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class ElseifChadContext extends ElseifCuckContext {
		public TerminalNode ELSE() { return getToken(TraductorCParser.ELSE, 0); }
		public TerminalNode IF() { return getToken(TraductorCParser.IF, 0); }
		public TerminalNode PA() { return getToken(TraductorCParser.PA, 0); }
		public CondicionContext condicion() {
		...
		public TerminalNode LC() { return getToken(TraductorCParser.LC, 0); }
		public ElseifChadContext(ElseifCuckContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitElseifChad(this);
			else return visitor.visitChildren(this);
		}
	}

	public final ElseifCuckContext elseifCuck() throws RecognitionException {
		ElseifCuckContext _localctx = new ElseifCuckContext(_ctx, getState());
		enterRule(_localctx, 20, RULE_elseifCuck);
		try {
	...
	public static class ForChadContext extends ForBasicoContext {
		public TerminalNode FOR() { return getToken(TraductorCParser.FOR, 0); }
		public TerminalNode PA() { return getToken(TraductorCParser.PA, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitForChad(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IdCondicionContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitIdCondicion(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TrueChadContext extends CondicionContext {
		public TerminalNode TRUE() { return getToken(TraductorCParser.TRUE, 0); }
		public TrueChadContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitTrueChad(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class OrContext extends CondicionContext {
		...
		public TerminalNode OR() { return getToken(TraductorCParser.OR, 0); }
		public OrContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitOr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AndContext extends CondicionContext {
		...
		public TerminalNode AND() { return getToken(TraductorCParser.AND, 0); }
		public AndContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitAnd(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MayorIgualContext extends CondicionContext {
		...
		public TerminalNode MAYORIGUAL() { return getToken(TraductorCParser.MAYORIGUAL, 0); }
		public TerminalNode MENORIGUAL() { return getToken(TraductorCParser.MENORIGUAL, 0); }
		public MayorIgualContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitMayorIgual(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FalseChadContext extends CondicionContext {
		public TerminalNode FALSE() { return getToken(TraductorCParser.FALSE, 0); }
		public FalseChadContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitFalseChad(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NegacionContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitNegacion(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IgualacionContext extends CondicionContext {
		...
		public TerminalNode IGUALACION() { return getToken(TraductorCParser.IGUALACION, 0); }
		public TerminalNode DIFERENTE() { return getToken(TraductorCParser.DIFERENTE, 0); }
		public IgualacionContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitIgualacion(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MayorMenorContext extends CondicionContext {
		...
		public TerminalNode MAYOR() { return getToken(TraductorCParser.MAYOR, 0); }
		public TerminalNode MENOR() { return getToken(TraductorCParser.MENOR, 0); }
		public MayorMenorContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitMayorMenor(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ParentesisCondicionContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitParentesisCondicion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ParentesisContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitParentesis(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PotenciaRaizContext extends ExprContext {
		...
		public TerminalNode POW() { return getToken(TraductorCParser.POW, 0); }
		public TerminalNode SQRT() { return getToken(TraductorCParser.SQRT, 0); }
		public PotenciaRaizContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitPotenciaRaiz(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SumResContext extends ExprContext {
		...
		public TerminalNode SUM() { return getToken(TraductorCParser.SUM, 0); }
		public TerminalNode RES() { return getToken(TraductorCParser.RES, 0); }
		public SumResContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitSumRes(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NegativoContext extends ExprContext {
		public TerminalNode RES() { return getToken(TraductorCParser.RES, 0); }
		public TerminalNode NUMERO() { return getToken(TraductorCParser.NUMERO, 0); }
		public NegativoContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitNegativo(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IdContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitId(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IntContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitInt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MulDivContext extends ExprContext {
		...
		public TerminalNode MUL() { return getToken(TraductorCParser.MUL, 0); }
		public TerminalNode DIV() { return getToken(TraductorCParser.DIV, 0); }
		public MulDivContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitMulDiv(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Tipo_datoContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(TraductorCParser.INT, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorCVisitor ) return ((TraductorCVisitor<? extends T>)visitor).visitTipo_dato(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IncrementoChadContext extends IncrementoContext {
		public TerminalNode ID() { return getToken(TraductorCParser.ID, 0); }
		public List<TerminalNode> SUM() { return getTokens(TraductorCParser.SUM); }
		public TerminalNode SUM(int i) {
			return getToken(TraductorCParser.SUM, i);
		}
		public IncrementoChadContext(IncrementoContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof